  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        ...
        />
        <motion.p
          className="text-sm text-drift-muted/50 max-w-md mx-auto leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      {categories.map((category, catIndex) => (
        ...
        >
          <div className="mb-3">
            ...
            <p className="text-[10px] text-drift-muted/40 italic">
          ...
          <div className="space-y-3">
            {category.findings.map((finding, fIndex) => (
              <motion.p
                key={fIndex}
                className="text-xs text-drift-text/55 leading-relaxed"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{
      ...
      >
        <p className="text-[10px] uppercase tracking-[0.2em] text-drift-muted/40 mb-3">
          System Summary
        </p>
        <p className="text-xs text-drift-text/55 leading-relaxed">
