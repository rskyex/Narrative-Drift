...
// ─── z3-filter: Political Filter Bubble ──────────────────
      ...
      <div className="px-4 pt-2 pb-4">
        ...
        >
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-[8px] text-white/20">3 notifications</span>
          </div>
        </motion.div>
        ...
        >
          ...
          {/* Image area */}
          <div className="h-16 bg-gradient-to-br from-slate-900/80 to-red-950/30 relative flex items-center justify-center">
            <div className="w-20 h-10 rounded bg-white/[0.03] border border-white/[0.04]" />
          </div>
        ...
        <motion.div
          className="rounded-lg border border-white/[0.03] bg-white/[0.01] p-2.5 opacity-30"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 1 }}
        >
  ...
  return (
    <DeviceFrame variant="panel">
      <div className="px-4 pt-3 pb-4">
        ...
        {/* Election info */}
        <motion.div
          className="px-2 py-1.5 rounded bg-white/[0.02] border border-white/[0.04] mb-3 flex items-center justify-between"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.4 }}
        >
          <span className="text-[9px] text-white/30">Local Election</span>
          <span className="text-[8px] text-amber-300/40">In 14 days</span>
        </motion.div>
...
// ─── z3-petition: AI-Drafted Petition ────────────────────
